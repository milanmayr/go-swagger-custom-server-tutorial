...
type ClientService interface {
	GetGreeting(params *GetGreetingParams, opts ...ClientOption) (*GetGreetingOK, error)
...
*/
func (a *Client) GetGreeting(params *GetGreetingParams, opts ...ClientOption) (*GetGreetingOK, error) {
